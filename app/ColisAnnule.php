...
class ColisAnnule extends Model
{
    public $timestamps = true;

    protected $fillable = ['etat1','etat2','ref','client','poids','codecolis','nomclient','telephone','wilaya','commune','adresse','codePostal','produits','livraison','remarque','prix', 'created_at']; 
