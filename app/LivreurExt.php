...
class LivreurExt extends Model
{
    use Notifiable;
    protected $guard = 'livreur_ext';

    protected $fillable = [
        'id_liv_ext','nom', 'email','prenom' , 'phone_number' , 'id_permis', 'expire_date' ,'etat' , 'matricule_vehicule' , 'modele_vehicule' 
        ,'couleur_vehicule' , 'note' , 'points' , 'code_parrainage' ,'password' 
    ];
