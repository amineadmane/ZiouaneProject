    ...
    methods: {
      ...
      createAdmin(){
        ...
        this.admins.push(this.form);
          ...
          this.$inertia.post(route('admin.nagentB'),this.form).then(()=> {
            this.$toast.open({
      ...
      updateAdmin(){
        ...
        this.$inertia.post(route('admin.uagentB'),this.editedItem).then(()=> { 
          this.$toast.open({
      ...
      deleteItemConfirm () {
        ...
        this.closeDelete()
        this.$inertia.post(route('admin.ragentB'),this.editedItem).then(()=> {
          this.$toast.open({
