      ...
      <v-main>
        ...
        >
          ...
          <template v-slot:[`item.details`]="{ item }">
            <div v-if="item.id_colisLivre!=undefined">
            <Inertia-link :href="`/colis/history/${item.id_colisLivre}`">
              <v-icon
                small
                color="primary"
                class="mr-2 mx-2"
            ...
            <div v-else>
              ...
              <Inertia-link :href="`/colis/history/${item.id_colisannule}`">
     ...
     this.search=this.search.toLowerCase();
      return this.colis.filter(colis =>{
        ...
        if(colis.livreur!=null)  if(
              colis.livreur['nom'].toLowerCase().match(this.search)!=null ) return true; 
        
        if(colis.livreur!=null)  if(
              colis.livreur['prenom'].toLowerCase().match(this.search)!=null ) return true; 
