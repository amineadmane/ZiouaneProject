...
class CreateColisAnnulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('colis_annules', function (Blueprint $table) {
            $table->bigIncrements('id_colisannule');
    ...
    {
        Schema::dropIfExists('colis_annules');
    }
}
