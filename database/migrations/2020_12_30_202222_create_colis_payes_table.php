...
class CreateColisPayesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('colis_payes', function (Blueprint $table) {
            $table->bigIncrements('id_colispaye');
    ...
    {
        Schema::dropIfExists('colis_payes');
    }
}
