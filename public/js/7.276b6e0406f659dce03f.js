    ...
    [
      ...
      _c(
        "v-dialog",
        {
          ...
          attrs: { "hide-overlay": "", "max-width": "800px" },
          model: {
            value: _vm.dialog,
            callback: function($$v) {
              _vm.dialog = $$v
                      ...
                      [
                        ...
                        },
                        {
                          ...
                          fn: function(ref) {
                            var item = ref.item
                            return [
                              item.livraison == null || item.livraison == 0
                                ? _c("p", [
                                    _vm._v(
