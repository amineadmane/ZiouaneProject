  ...
  methods: {
    changerEtat: function changerEtat() {
      ...
      if (this.selected.length != 0) this.selected.forEach(function (element) {
        ...
        _this3.annules[_this3.colis.indexOf(element)] = element;
      });else this.selectedLiv.forEach(function (element) {
        element.etat1 = _this3.etat;
        _this3.livres[_this3.colis.indexOf(element)] = element;
      });
      if (this.selected.length != 0) form.selected = this.selected;else form.selected = form.etat = this.etat;
