...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    findTotal: function findTotal(item) {
      ...
      console.log(item);
      console.log(this.tableItems[0]);
      this.tableItems[item - 1].forEach(function (element) {
