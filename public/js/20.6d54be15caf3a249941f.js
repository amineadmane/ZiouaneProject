...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    findTotal: function findTotal(item) {
      ...
      console.log(item); //console.log(Object.values(item));
