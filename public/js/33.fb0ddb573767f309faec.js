...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filteredWilayas: function filteredWilayas() {
      var _this = this;

      this.search = this.search.toLowerCase();
      return this.wilayas.filter(function (colis) {
        return colis.nom.toLowerCase().match(_this.search) != null || colis.fraisLivraison.toString().toLowerCase().match(_this.search) != null;
      });
    }
  },
  data: function data() {
