...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      var result = this.colis.filter(function (colis) {
        if (colis.livreur != null) if (colis.livreur['nom'].toLowerCase().match(_this.search) || colis.livreur['prenom'].toLowerCase().match(_this.search)) return true;
        if (colis.etat1 != null) if (colis.etat1.toLowerCase().match(_this.search)) return true;
        if (colis.etat2 != null) if (colis.etat2.toLowerCase().match(_this.search)) return true;
        return colis.client['nom'].toLowerCase().match(_this.search) || colis.client['prenom'].toLowerCase().match(_this.search) || colis.ref.toLowerCase().match(_this.search) || colis.etat1.toLowerCase().match(_this.search) || colis.etat2.toLowerCase().match(_this.search) || colis.codecolis.toLowerCase().match(_this.search) || colis.nomclient.toLowerCase().match(_this.search) || colis.wilaya['nom'].toLowerCase().match(_this.search) || colis.commune['nom'].toLowerCase().match(_this.search) || colis.codePostal.toLowerCase().match(_this.search) || colis.adresse.toLowerCase().match(_this.search) || colis.prix.toLowerCase().match(_this.search) || colis.produits.toLowerCase().match(_this.search);
      });
