                        ...
                        return [
                          _vm._v(
                            "\n            " +
                              _vm._s(
                                item.livraison == 0
                                  ? item.wilaya["fraisLivraison"] + item.prix
                                  : item.prix
                              ) +
                              "\n          "
                          )
                      ...
                      fn: function(ref) {
                        ...
                        return [
                          _c(
                            ...
                            {
                              attrs: {
                                color: item.livraison == 1 ? "red" : "primary"
                              }
                            },
                            [
                              _vm._v(
                      ...
                      fn: function(ref) {
                        ...
                        return [
                          _c(
                            ...
                            {
                              attrs: {
                                href: "/administration/history/" + item.id_colis
                              }
                            },
                            [
                              _c(
