...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    findTotal: function findTotal(item) {
      var total = 0; //alert(item);

      console.log(Object.values(this.nonprets[item - 1]));
      Object.values(this.nonprets[item - 1]).forEach(function (element) {
        alert(JSON.stringify(element)); //return total=total+element.prix
      });
    }
  },
