...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      adresse: '',
      commune: ''
    }), _defineProperty(_ref, "itemsPerPage", 4), _defineProperty(_ref, "headersSuperA", [{
      text: 'Nom',
      align: 'start',
      sortable: false,
      value: 'nom'
  ...
  methods: {
    ...
    onChange: function onChange() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get('/communes/' + this.form.wilaya).then(function (response) {
    ...
    refreshClients: function refreshClients() {
      this.$inertia.visit(route('admin.clients'));
    },
    editItem: function editItem(item) {
      this.editedIndex = this.tableItems.indexOf(item); //alert(this.editedIndex);
    ...
    filterElements: function filterElements() {
      ...
      if (this.filtered) this.tableItems = this.colis.filter(function (element) {
        return element.wilaya['id'] == _this7.$page.auth.user.wilaya;
    ...
    filterCentre: function filterCentre() {
      ...
      if (this.filtered) this.tableItems = this.colis.filter(function (element) {
        return element.wilaya['id'] in _this8.wilayas;
      });else this.tableItems = this.colis;
      return this.tableItems;
    }
  }
