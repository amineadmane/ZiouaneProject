  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      result = this.colis.filter(function (colis) {
        ...
        return colis.ref.toLowerCase().match(_this.search) != null || colis.codecolis.toLowerCase().match(_this.search) != null || colis.nomclient.toLowerCase().match(_this.search) || colis.codePostal.toLowerCase().match(_this.search) || colis.adresse.toLowerCase().match(_this.search) || colis.produits.toLowerCase().match(_this.search);
      });
      alert(result);
