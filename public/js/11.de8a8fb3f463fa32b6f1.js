...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createAdmin: function createAdmin() {
      ...
      this.$inertia.post(route('admin.nagentC'), this.form).then(function () {
        _this3.$toast.open({
    ...
    updateAdmin: function updateAdmin() {
      ...
      this.$inertia.post(route('admin.uagentC'), this.editedItem).then(function () {
        _this4.$toast.open({
    ...
    deleteItemConfirm: function deleteItemConfirm() {
      ...
      this.closeDelete();
      this.$inertia.post(route('admin.ragentC'), this.editedItem).then(function () {
        _this5.$toast.open({
