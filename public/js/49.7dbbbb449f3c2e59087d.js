  ...
  computed: {
    ...
    filteredColis: function filteredColis() {
      ...
      return this.indexedItems.filter(function (colis) {
        ...
        return c.client.nom.toLowerCase().match(_this.search) != null || c.client.prenom.toLowerCase().match(_this.search) != null || c.client.telephone.toLowerCase().match(_this.search) != null || c.client.adresse.toLowerCase().match(_this.search) != null || colis.codePostal.toLowerCase().match(_this.search) != null || colis.adresse.toLowerCase().match(_this.search) != null || colis.produits.toLowerCase().match(_this.search) != null;
      });
    }
  },
