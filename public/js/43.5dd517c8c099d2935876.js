...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    goBack: function goBack() {
      this.$inertia.go(route('client.colis'));
    },
                                ...
                                fn: function() {
                                  return [
                                    _c("span", {
                                      ...
                                      domProps: {
                                        textContent: _vm._s(log.created_at)
                                      }
                                    })
                                  ]
                                },
