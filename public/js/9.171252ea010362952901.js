  ...
  computed: {
    filteredAdmins: function filteredAdmins() {
      ...
      return this.centres.filter(function (colis) {
        ...
        if (fount) return colis.nom.toLowerCase().match(_this.search) != null || colis.prenom.toLowerCase().match(_this.search) != null || colis.email.toLowerCase().match(_this.search) != null;
      });
    }
  },
  data: function data() {
