  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      result = this.colis.filter(function (colis) {
        if (colis.wilaya != null) if (colis.wilaya['nom'].toLowerCase().match(_this.search)) return true;
        if (colis.commune != null) if (colis.commune['nom'].toLowerCase().match(_this.search)) return true;
