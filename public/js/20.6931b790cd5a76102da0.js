...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    findTotal: function findTotal(items) {
      var total = 0;
      console.log(items);
      return this.tableItems.map(function (obj) {
        return Object.assign({}, obj, {
          fullAddress: "".concat(obj.street, "\n").concat(obj.city, ", ").concat(obj.state, " ").concat(obj.zip)
        });
      });
      this.tableItems[items].forEach(function (element) {
