  ...
  computed: {
    ...
    filteredColis: function filteredColis() {
      ...
      return this.indexedItems.filter(function (colis) {
        var c = colis[0];
        if (c.client.wilaya != null && _typeof(c.client.wilaya) == 'object') if (c.client.wilaya.toLowerCase().match(_this.search) != null) {
          return true;
        }
        if (c.client.commune != null && _typeof(c.client.commune) == 'object') if (c.client.commune['nom'].toLowerCase().match(_this.search) != null) return true;
  ...
  methods: {
    ...
    totalRamasser: function totalRamasser(item) {
      ...
      item.forEach(function (element) {
        if (element.livraison == 1) return total = total + element.wilaa;
      });
    },
