  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      result = this.colis.filter(function (colis) {
        alert(colis);
        alert(colis.nomclient);
        if (colis.wilaya != null) if (colis.wilaya.toString().toLowerCase().match(_this2.search) != null) {
          return true;
        }
        if (colis.commune != null) if (colis.commune.toString().toLowerCase().match(_this2.search) != null) return true;
        if (colis.remarque != null) if (colis.remarque.toString().toLowerCase().match(_this2.search) != null) return true;
        return colis.ref.toString().toLowerCase().match(_this2.search) != null || colis.codecolis.toString().toLowerCase().match(_this2.search) != null || colis.telephone.match(_this2.search) != null || colis.nomclient.toString().toLowerCase().match(_this2.search) != null || colis.codePostal.toLowerCase().match(_this2.search) != null || colis.adresse.toString().toLowerCase().match(_this2.search) != null || colis.produits.toString().toLowerCase().match(_this2.search) != null;
      });
