...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    ...
    return _ref = {
      ...
      dialogPret: false,
      dialognonPret: false
    }, _defineProperty(_ref, "dialogPret", false), _defineProperty(_ref, "filtered", false), _defineProperty(_ref, "singleExpand", false), _defineProperty(_ref, "totalPayes", 0), _defineProperty(_ref, "totalPret", 0), _defineProperty(_ref, "totalProchain", 0), _defineProperty(_ref, "livreur", ''), _defineProperty(_ref, "x", ''), _defineProperty(_ref, "etat", "pret"), _defineProperty(_ref, "selected", []), _defineProperty(_ref, "dialog", false), _defineProperty(_ref, "singleSelect", true), _defineProperty(_ref, "page", 1), _defineProperty(_ref, "items", ['pret', 'pas pret']), _defineProperty(_ref, "tableItems", []), _defineProperty(_ref, "search", ''), _defineProperty(_ref, "pageCount", 0), _defineProperty(_ref, "editedItem", {
      nomclient: '',
      telephone: '',
      wilaya: '',
      commune: '',
