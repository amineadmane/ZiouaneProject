  ...
  computed: {
    ...
    filteredColis: function filteredColis() {
      ...
      return this.indexedItems.filter(function (colis) {
        var c = colis[0];
        if (c.client != null) if (c.toLowerCase().match(_this.search) != null) {
          return true;
        }
        if (colis.livreur != null) if (colis.Livreur['nom'].toLowerCase().match(_this.search) != null || colis.Livreur['prenom'].toLowerCase().match(_this.search) != null) {
          return true;
        }
        if (c.client.commune != null && _typeof(c.client.commune)) if (c.client.commune['nom'].toLowerCase().match(_this.search) != null) return true;
        if (colis.etat1 != null) if (colis.etat1.toLowerCase().match(_this.search) != null) return true;
        return c.client.nom.toLowerCase().match(_this.search) != null || c.client.prenom.toLowerCase().match(_this.search) != null || c.client.telephone.toLowerCase().match(_this.search) != null || c.client.adresse.toLowerCase().match(_this.search) != null;
      });
    }
  },
