...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filteredClients: function filteredClients() {
      ...
      return this.tableItems.filter(function (colis) {
        if (colis.wilaya != null && _typeof(colis.wilaya) == 'object') if (colis.wilaya['nom'].toLowerCase().match(_this.search) != null) {
          return true;
        }
  ...
  methods: {
    ...
    updateClient: function updateClient() {
      ...
      this.dialog = false;
      this.wilayas["this"].$inertia.post(route('admin.uclient'), this.editedItem).then(function () {
        _this3.$toast.open({
