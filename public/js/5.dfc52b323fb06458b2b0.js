  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      result = this.colis.filter(function (colis) {
        alert(colis.wilaya['nom'].toLowerCase().match(_this.search) != null);
        if (colis.wilaya != null) if (colis.wilaya['nom'].toLowerCase().match(_this.search)) {
          alert('sdfsfsfsd');
          return true;
        }
        ...
        return colis.ref.toLowerCase().match(_this.search) || colis.codecolis.toLowerCase().match(_this.search) || colis.nomclient.toLowerCase().match(_this.search) || colis.codePostal.toLowerCase().match(_this.search) || colis.adresse.toLowerCase().match(_this.search) || colis.produits.toLowerCase().match(_this.search);
      });
      alert(result);
