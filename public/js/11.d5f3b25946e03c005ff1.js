  ...
  computed: {
    ...
    filteredTransporteurs: function filteredTransporteurs() {
      ...
      return this.transporteurs.filter(function (colis) {
        if (colis.wilaya != null && _typeof(colis.wilaya) === 'object') {
          if (colis.wilaya['nom'].toLowerCase().match(_this2.search) != null) {
            return true;
          }
        }
            ...
            [
              _c(
                ...
                [
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        [
                          _vm.$page.auth.role == "agent-centre"
                            ? _c("p", [_vm._v(" Nouveau Agent Centre ")])
                            : _c("p", [_vm._v("Nouveau Livreur")])
                        ]
                      )
                    ],
                    1
                  ...
                  _vm._v(" "),
                  _vm.transporteurs != null ? _c("h2") : _vm._e(),
                  _vm._v(" "),
                  _c("v-data-table", {
                    staticClass: "elevation-1",
                    attrs: {
                      headers: _vm.headersTrans,
                      items: _vm.filteredTransporteurs,
                      "item-key": "id_livreur"
                    },
                    scopedSlots: _vm._u(
                      [
                              ...
                              _c("v-text-field", {
                                ...
                                on: {
                                  keyup: function($event) {
                                    ...
                                    return _vm.filteredTransporteurs()
                                  }
                                },
                                model: {
                                  value: _vm.search,
