...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filteredAdmins: function filteredAdmins() {
      ...
      return this.admins.filter(function (colis) {
        ...
        return colis.wilaya['nom'].toLowerCase().match(_this.search) != null || colis.prenom.toLowerCase().match(_this.search) != null || colis.email.toLowerCase().match(_this.search) != null;
      });
    }
  },
  data: function data() {
