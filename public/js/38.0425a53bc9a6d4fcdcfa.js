  ...
  computed: {
    filteredColis: function filteredColis() {
      ...
      return this.colis.filter(function (colis) {
        ...
        if (colis.livreur != null) if (colis.livreur['nom'].toLowerCase().match(_this.search) != null) return true;
        if (colis.livreur != null) if (colis.livreur['prenom'].toLowerCase().match(_this.search) != null) return true;
