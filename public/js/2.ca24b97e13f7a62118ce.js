...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    filteredAnnules: function filteredAnnules() {
      var _this = this;

      var result = [];
      this.search = this.search.toLowerCase();
      return this.annules.filter(function (colis) {
        ...
        if (colis.remarque != null) if (colis.remarque.toLowerCase().match(_this.search) != null) return true;
    ...
    filteredLivres: function filteredLivres() {
      var _this2 = this;

      var result = [];
      this.search = this.search.toLowerCase();
      return this.livres.filter(function (colis) {
        if (colis.wilaya != null) if (colis.wilaya['nom'].toLowerCase().match(_this2.search) != null) {
          return true;
        }
        if (colis.commune != null) if (colis.commune['nom'].toLowerCase().match(_this2.search) != null) return true;
        if (colis.etat1 != null) if (colis.etat1.toLowerCase().match(_this2.search) != null) return true;
        if (colis.etat2 != null) if (colis.etat2.toLowerCase().match(_this2.search) != null) return true;
        if (colis.remarque != null) if (colis.remarque.toLowerCase().match(_this2.search) != null) return true;
  ...
  methods: {
    changerEtat: function changerEtat() {
      ...
      if (this.selected.length == 0 || this.selectedLiv.length == 0) return this.$toast.open({
      ...
      var form = {};
      if (this.selected.length != 0) this.selected.forEach(function (element) {
        element.etat1 = _this3.etat;
        _this3.annules[_this3.annules.indexOf(element)] = element;
      });else this.selectedLiv.forEach(function (element) {
        element.etat1 = _this3.etat;
        _this3.livres[_this3.livres.indexOf(element)] = element;
      });
      if (this.selected.length != 0) form.selected = this.selected;else form.selected = this.selectedLiv;
      form.etat = this.etat;
      if (this.selectedLiv.length != 0) this.$inertia.post(route('admin.changerEtatLiv'), form).then(function () {
        _this3.selected = [];
      ...
      });else this.$inertia.post(route('admin.changerEtatAnnu'), form).then(function () {
        _this3.selected = [];
